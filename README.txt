...
bitnami-mampstack-8.1.9-0-osx-x86-installer.dmg 
...
a regular user, or /opt/mampstack-8.1.9-0, if you are running the 
...
The default listening port for Apache is 8080 and for MariaDB is 3306. If those 
...
/Applications/mampstack-8.1.9-0 and that you use port 8080 for Apache and 3306 for MariaDB.
