...
if ('/Applications/mampstack-8.1.9-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/mampstack-8.1.9-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
